...
def predict(range_file,model_file):
	...
	os.system(home + '/../libsvm-3.22/svm-scale -r '+ range_file + ' test.f_svm  > test.scaled ')
	os.system(home + '/../libsvm-3.22/svm-predict -b 1 test.scaled ' + model_file +' tmp.txt >  tmp2.txt')
...
def main():
	...
	output_feature(args.RNA_file,args.hexmar,args.species)
	predict(args.range,args.model)
	merge(args.outfile)
	deleted()
