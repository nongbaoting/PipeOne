...
def run_defusion(low_dim, alpha, gamma, view, test='false'):
    ...
    defusion_ = DeFusion(low_dim, alpha, gamma, silence=True, set_seed=True, test=test)
...
def MYRUN_DF(threads, test='false' ):
    ...
    Parallel(n_jobs=threads)(delayed(run_defusion)( params_["low_dim"],
                                                    params_["alpha"],
                                                    params_["gamma"], view, test) for params_ in params_grid)
