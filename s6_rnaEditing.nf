...
process merge_A2I {
	...
	output:
	tuple "SPRINT_all.tsv", "SPRINT_A2I.tsv", "SPrint_A2I_table.tsv" into merge_out
...
if (params.snp){
	...
	process snpFilter{
		...
		input:
		tuple   "SPRINT_all.tsv", "SPRINT_A2I.tsv", "SPrint_A2I_table.tsv" from merge_out.collect()
		file "snpFile" from snpFile
		
		output:
		set  "SPRINT_all.filterSNP.tsv", "SPRINT_A2I_table.filterSNP.tsv"
		
		"""
		python3 ${baseDir}/scripts/rnaEditing.py filter_tab snpFile SPrint_A2I_table.tsv SPrint_A2I_table.filterSNP.tsv
		python3 ${baseDir}/scripts/rnaEditing.py filter_res snpFile SPRINT_all.tsv SPRINT_all.filterSNP.tsv
		python3 ${baseDir}/scripts/rnaEditing.py filter_res snpFile SPRINT_A2I.tsv SPRINT_A2I.filterSNP.tsv
